...
Automated builds of the image are available on [Dockerhub](https://hub.docker.com/r/gnh1201/openfire) and is the recommended method of installation.

```bash
docker pull gnh1201/openfire:4.4.4
```

Alternatively you can build the image yourself.

```bash
docker build -t gnh1201/openfire github.com/gnh1201/docker-openfire
```
